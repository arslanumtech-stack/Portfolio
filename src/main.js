  ...
  <main id="top">
    <section class="profile-shell" id="about">
      <aside class="profile-card">
        ...
        <div class="profile-links"><a href="https://github.com/arslanumtech-stack" target="_blank" rel="noreferrer"><svg class="social-icon" aria-hidden="true" viewBox="0 0 24 24"><path d="M12 2a10 10 0 0 0-3.16 19.49c.5.09.68-.22.68-.48v-1.7c-2.78.6-3.37-1.18-3.37-1.18-.46-1.16-1.11-1.47-1.11-1.47-.91-.62.07-.61.07-.61 1 .07 1.53 1.03 1.53 1.03.9 1.53 2.34 1.09 2.91.83.09-.65.35-1.09.63-1.34-2.22-.25-4.55-1.11-4.55-4.94 0-1.09.39-1.98 1.03-2.68-.1-.25-.45-1.27.1-2.65 0 0 .84-.27 2.75 1.02A9.6 9.6 0 0 1 12 7.9c.85 0 1.7.12 2.5.36 1.91-1.29 2.75-1.02 2.75-1.02.55 1.38.2 2.4.1 2.65.64.7 1.03 1.59 1.03 2.68 0 3.84-2.34 4.68-4.57 4.93.36.31.68.92.68 1.85v2.74c0 .27.18.58.69.48A10 10 0 0 0 12 2Z" /></svg>GitHub <span>↗</span></a><a href="https://www.linkedin.com/in/arslan-haider-0b38073a7/" target="_blank" rel="noreferrer"><svg class="social-icon" aria-hidden="true" viewBox="0 0 24 24"><path d="M5.1 8.2H2.2V21h2.9V8.2ZM3.65 3A1.7 1.7 0 1 0 3.65 6.4 1.7 1.7 0 0 0 3.65 3ZM21.8 13.67c0-3.86-2.06-5.66-4.82-5.66-2.22 0-3.21 1.22-3.76 2.08V8.2h-2.9V21h2.9v-6.34c0-1.67.31-3.29 2.39-3.29 2.04 0 2.06 1.91 2.06 3.4V21h2.9l.03-7.33Z" /></svg>LinkedIn <span>↗</span></a><a href="https://www.upwork.com/freelancers/~01d879110205d55b29" target="_blank" rel="noreferrer"><svg class="social-icon" aria-hidden="true" viewBox="0 0 24 24"><path d="M18.7 7.3c-1.7 0-3.1 1.1-3.8 2.7-.9-.6-1.8-1.5-2.5-2.6l.1-.4H9.7v5.4c0 1.5-.7 2.4-1.7 2.4s-1.7-.9-1.7-2.4V7H3.8v5.4c0 3 1.7 5.2 4.2 5.2 2.2 0 3.8-1.7 4-4.4.7 1 1.7 1.8 2.9 2.4.3 2.3 1.8 3.8 3.8 3.8 2.3 0 4.1-1.8 4.1-4.1V7.3h-4.1Zm0 9.2c-.7 0-1.3-.6-1.4-1。6.4。1。9。1。1。4。1。5。0。9。-。1。1。3。-。2。-。1。1。0。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6， 。6، .
        <a class="profile-email" href="mailto:arslanum.tech@gmail.com"><svg class="social-icon" aria-hidden="true" viewBox="0 0 24 24"><path d="M3 5h18v14H3V5Zm2 2v.6l7 4.8 7-4.8V7l-7 4.8L5 7Z" /></svg>Gmail <span>↗</span></a>
      </div>
      </aside>

      <div class="intro-panel">
        <div class="intro-panel__top"><span>01. ABOUT</span><span>LAST UPDATED / 2026</span></div>
    ...
    <section class="contact-section" id="contact"><p class="eyebrow">05. LET'S CONNECT</p><h2>Have a problem<br />worth <em>solving?</em></h2><a class="email-link" href="mailto:arslanum.tech@gmail.com">arslanum.tech@gmail.com <span>↗</span></a><div class="connection-link"><span>Ahmad Bashir</span><small>AI/ML Engineer · Generative AI · Computer Vision</small></div><p class="connection-description">Ahmad Bashir is an AI/ML Engineer at Colossyan specializing in generative AI, computer vision, 3D vision, real-time video processing, and AI avatar synchronization. He builds scalable machine learning pipelines and agentic AI workflows using PyTorch and diffusion models.</p></section>
  </main>
  <footer class="footer"><span>© 2026 Arslan Haider</span><div><a href="https://github.com/arslanumtech-stack" target="_blank" rel="noreferrer"><svg class="social-icon" aria-hidden="true" viewBox="0 0 24 24"><path d="M12 2a10 10 0 0 0-3.16 19.49c.5.09.68-.22.68-.48v-1.7c-2.78.6-3.37-1.18-3.37-1.18-.46-1.16-1.11-1.47-1.11-1.47-.91-.62.07-.61.07-.61 1 .07 1.53 1.03 1.53 1.03.9 1.53 2.34 1.09 2.91.83.09-.65.35-1.09.63-1.34-2.22-.25-4.55-1.11-4.55-4.94 0-1.09.39-1.98 1.03-2.68-.1-.25-.45-1.27.1-2.65 0 0 .84-.27 2.75 1.02A9.6 9.6 0 0 1 12 7.9c.85 0 1.7.12 2.5.36 1.91-1.29 2.75-1.02 2.75-1.02.55 1.38.2 2.4.1 2.65.64.7 1.03 1.59 1.03 2.68 0 3.84-2.34 4.68-4.57 4.93.36.31.68.92.68 1.85v2.74c0 .27.18.58.69.48A10 10 0 0 0 12 2Z" /></svg>GitHub</a><a href="https://www.linkedin.com/feed/" target="_blank" rel="noreferrer"><svg class="social-icon" aria-hidden="true" viewBox="0 0 24 24"><path d="M5.1 8.2H2.2V21h2.9V8.2ZM3.65 3A1.7 1.7 0 1 0 3.65 6.4 1.7 1.7 0 0 0 3.65 3ZM21.8 13.67c0-3.86-2.06-5.66-4.82-5.66-2.22 0-3.21 1.22-3.76 2.08V8.2h-2.9V21h2.9v-6.34c0-1.67.31-3.29 2.39-3.29 2.04 0 2.06 1.91 2.06 3.4V21h2.9l.03-7.33Z" /></svg>LinkedIn</a><a href="https://www.upwork.com/freelancers/~01d879110205d55b29" target="_blank" rel="noreferrer"><svg class="social-icon" aria-hidden="true" viewBox="0 0 24 24"><path d="M18.7 7.3c-1.7 0-3.1 1.1-3.8 2.7-.9-.6-1.8-1.5-2.5-2.6l.1-.4H9.7v5.4c0 1.5-.7 2.4-1.7 2.4s-1.7-.9-1.7-2.4V7H3.8v5.4c0 3 1.7 5.2 4.2 5.2 2.2 0 3.8-1.7 4-4.4.7 1 1.7 1.8 2.9 2.4.3 2.3 1.8 3.8 3.8 3.8 2.3 0 4.1-1.8 4.1-4.1V7.3h-4.1Zm0 9.2c-.7 0-1.3-.6-1.4-1.6.4.1.9.1 1.4.1.5 0 .9-.1 1.3-.2-.1 1-.6 1.7-1.3 1.7Zm0-3.9c-.6 0-1.1-.1-1.6-.3  .2-1.2.8-2.2 1.6-2.2.8 0 1.4.6 1.4 1.2 0 .8-.5 1.3-1.4 1.3Z" /></svg>Upwork</a><a href="mailto:arslanum.tech@gmail.com"><svg class="social-icon" aria-hidden="true" viewBox="0 0 24 24"><path d="M3 5h18v14H3V5Zm2 2v.6l7 4.8 7-4.8V7l-7 4.8L5 7Z" /></svg>Gmail</a></div><span>Scroll with intention ↓</span></footer>
`

const profileLinks = document.querySelector('.profile-links')
profileLinks.innerHTML = `
  <a href="https://github.com/arslanumtech-stack" target="_blank" rel="noreferrer"><svg class="social-icon" aria-hidden="true" viewBox="0 0 24 24"><path d="M12 2a10 10 0 0 0-3.16 19.49c.5.09.68-.22.68-.48v-1.7c-2.78.6-3.37-1.18-3.37-1.18-.46-1.16-1.11-1.47-1.11-1.47-.91-.62.07-.61.07-.61 1 .07 1.53 1.03 1.53 1.03.9 1.53 2.34 1.09 2.91.83.09-.65.35-1.09.63-1.34-2.22-.25-4.55-1.11-4.55-4.94 0-1.09.39-1.98 1.03-2.68-.1-.25-.45-1.27.1-2.65 0 0 .84-.27 2.75 1.02A9.6 9.6 0 0 1 12 7.9c.85 0 1.7.12 2.5.36 1.91-1.29 2.75-1.02 2.75-1.02.55 1.38.2 2.4.1 2.65.64.7 1.03 1.59 1.03 2.68 0 3.84-2.34 4.68-4.57 4.93.36.31.68.92.68 1.85v2.74c0 .27.18.58.69.48A10 10 0 0 0 12 2Z" /></svg>GitHub <span>↗</span></a>
  <a href="https://www.linkedin.com/feed/" target="_blank" rel="noreferrer"><svg class="social-icon" aria-hidden="true" viewBox="0 0 24 24"><path d="M5.1 8.2H2.2V21h2.9V8.2ZM3.65 3A1.7 1.7 0 1 0 3.65 6.4 1.7 1.7 0 0 0 3.65 3ZM21.8 13.67c0-3.86-2.06-5.66-4.82-5.66-2.22 0-3.21 1.22-3.76 2.08V8.2h-2.9V21h2.9v-6.34c0-1.67.31-3.29 2.39-3.29 2.04 0 2.06 1.91 2.06 3.4V21h2.9l.03-7.33Z" /></svg>LinkedIn <span>↗</span></a>
  <a href="https://www.upwork.com/freelancers/~01d879110205d55b29" target="_blank" rel="noreferrer"><span class="social-icon social-icon--upwork" aria-hidden="true">up</span>Upwork <span>↗</span></a>
  <a href="mailto:arslanum.tech@gmail.com"><svg class="social-icon" aria-hidden="true" viewBox="0 0 24 24"><path d="M3 5h18v14H3V5Zm2 2v.6l7 4.8 7-4.8V7l-7 4.8L5 7Z" /></svg>Gmail <span>↗</span></a>
`

const header = document.querySelector('.topbar')
document.querySelectorAll('a[href="https://www.linkedin.com/feed/"]').forEach((link) => {
  link.href = 'https://www.linkedin.com/in/arslan-haider-0b38073a7/'
})
